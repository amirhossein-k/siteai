...
const suites = [
  ...
  "verify-product-discounts", // Session 77 — product discounts / sale pricing (admin create/update 201, supplier strip, invalid 400, effectivePrice + no config leak, discounted=true excludes future/expired/disabled/out-of-stock/inactive, checkout 409 on stale/manipulated price, coupon on discounted subtotal, immutable order snapshot, homepage section)
