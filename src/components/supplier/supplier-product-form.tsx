      ...
      <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              نام، دسته‌بندی و توضیحات محصول را وارد کنید
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>برند، برچسب‌ها و دسته‌بندی</CardTitle>
            <CardDescription>
              برند، برچسب‌ها و دسته‌بندی محصول را انتخاب کنید
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            {/* Tags Multi-Select */}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      مبلغی که فروشگاه به شما پرداخت می‌کند
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
        ...
        <Card className="border-emerald-200 bg-emerald-50 dark:border-emerald-800 dark:bg-emerald-950">
          <CardContent className="p-4">
            <p className="text-sm text-emerald-700 dark:text-emerald-300">
              <strong>نکته:</strong> فروشنده (تأمین‌کننده) شما به صورت خودکار
              تعیین می‌شود و نیازی به انتخاب آن نیست.
            </p>
          </CardContent>
        </Card>
